...
<template>
  <div class="modal-overlay">
    <div
      class="modal-con"
      :class="{ shifed: isResetModalOpen || isSubmitModalOpen }"
    >
      ...
      <div class="box-row modal-content">
        <div class="box-col modal-content-left">
          ...
          <div class="box-col left-tier-box">
            ...
            <Exp
              ...
              :percentage="uStore.user.percent"
              class="rank-exp"
            />
          </div>
        ...
        <div class="modal-content-right">
          ...
          <div class="right-solved-box">
            ...
            >
              <span
                :class="tier(problem.level)"
                @click="openSubmitListModal(problem.no)"
                >{{ problem.no }}</span
              >
            </div>
          </div>
